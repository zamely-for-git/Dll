...
CMyDllTestDlg::CMyDllTestDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMyDllTestDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CMyDllTestDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(ID_BTN_ADD, &CMyDllTestDlg::OnBnClickedBtnAdd)
	ON_BN_CLICKED(ID_BTN_SUB, &CMyDllTestDlg::OnBnClickedBtnSub)
END_MESSAGE_MAP()


// CMyDllTestDlg 消息处理程序
...
void CMyDllTestDlg::OnBnClickedBtnAdd()
{
	// TODO: 在此添加控件通知处理程序代码
	CString str;
...
void CMyDllTestDlg::OnBnClickedBtnSub()
{
	// TODO: 在此添加控件通知处理程序代码
	CString str;
